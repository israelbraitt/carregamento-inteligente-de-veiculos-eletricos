...
class Carro:
    ...
    def getTCP_host(self):
        """
        Retorna o host da conexão TCP
    ...
    def setTCP_host(self, new_tcp_host):
        """
        Altera o host da conexão TCP

            Argumentos:
                new_tcp_host (str): novo host da conexão TCP
        """
        self.tcp_host = new_tcp_host

    def getTCP_port(self):
        """
        Retorna a porta da conexão TCP

            Retorno:
                Porta da conexão TCP
        """
        return self.tcp_port
    
    def setTCP_port(self, new_tcp_port):
        """
        Altera a porta da conexão TCP

            Parâmetros:
                new_tcp_port (int): nova para da conexão TCP
        """
        self.tcp_port = new_tcp_port
